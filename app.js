  ...
  day1: [
    {
      ...
      schedule: [
        { time: "04:30", place: "전주집결(월드컵경기장 주차장)", distanceKm: 0, cumulativeDistanceKm: 0, detail: "신분증·자전거 수리 도구·개인가방·승선권 확인" },
        { time: "05:00", place: "전주 출발", detail: "전주월드컵경기장 주차장 → 목포 1시간 51분·164km, 목포항 국제여객터미널 07:00 전후 도착 목표" },
...
const transportOptions = [
  {
    ...
    outbound: "04:30 전주집결(월드컵경기장 주차장) → 05:00 차량 출발(목포까지 1시간 51분·164km) → 07:00 목포항 수속·주차 → 08:30 목포 출항 → 12:50 전후 제주항 하선",
...
function setupVWorldRouteEditor() {
  ...
  // Keep previously shared event links working after the menu rename.
  const requestedPanel = initialParams.get("panel") === "event" ? "meeting" : initialParams.get("panel");
